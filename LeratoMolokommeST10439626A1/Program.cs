...
namespace LeratoMolokommeST10439626A1
{
                ...
                while (true)
                {
                    ...
                    switch (question.ToLower())
                    {
                        ...
                        case "phinishing":
                            ...
                            Console.WriteLine("- Malicious websites that mimic legitimate ones");
                            Console.WriteLine("- Urgent requests for personal information");
                            Console.WriteLine("Always verify the sender's identity before responding to requests for sensitive information.");
